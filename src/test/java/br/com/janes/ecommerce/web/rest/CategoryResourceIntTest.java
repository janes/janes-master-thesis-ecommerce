...
import br.com.janes.ecommerce.repository.CategoryRepository;
...
public class CategoryResourceIntTest {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getUrl()).isEqualTo(DEFAULT_URL);
    ...
    public void updateCategory() throws Exception {
        ...
        assertThat(testCategory.getUrl()).isEqualTo(UPDATED_URL);
