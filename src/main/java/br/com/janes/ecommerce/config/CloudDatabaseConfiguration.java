package br.com.janes.ecommerce.config;
...
@Configuration
@EnableMongoRepositories("br.com.janes.ecommerce.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("br.com.janes.ecommerce.config.dbmigrations");
